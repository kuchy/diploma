...
Výsledná priemerná hodnota pre AUC 0.651.
...
\subsubsection{Coutrot #1}
V datasete Coutrot #1 boli z testovania vynaté videá číslo: 10, 15 z dôvodu chybového spracovanie v jednom alebo viacej testovacích modelov.
\begin{figure}[H]
...
Celkové hodnotenie benchamrku znazorním porovnanním priemerov vsektých datasetov spolu.
...
Ďaľšia možnosť ako vylepšiť je v rýchlosti spracovania, ktorá nie je použiteľná na realtime spracovanie obrazu.
...
Ďaľšiu možnosť pre zlepšenie odhaľuje validácia datasetu Coutrot #2, kde pôvodný algotritmus horn-struck dosiahol hodnotenie porovnateľné s navrhovaným modelom.
