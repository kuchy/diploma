...
Výsledky budeme hodnotiť pomocou nasledkujúcich metrík:
\begin{enumerate}
...
Možnosť na zlepšenie algoritmu vidieť, v benchmarku kde model Rare\cite{rare-1} dosahoval výrazne lepšie výsledky aj napriek používaniu iba statických príznakov.
