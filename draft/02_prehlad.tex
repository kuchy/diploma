...
K datasetu je taktiež dostupný validačný kód\cite{accv} vypočítavajúci hodnotiace metriky.

\subsection{Coutrot DATASETS}
...
Druhý dataset \cite{coutrot-database-2} bol obsahuje 15 videí.
Všetky videá obsahujú nahraté stretnutie 4 konverzujúcich ludí so statickou kamerou.
...
Eyetracker nahrával iba dáta z dominantného oka.
...
Pre účeli validácie bude vypracovaný podobný benchmark určený pre porovnanie na rozvnakých vstupoch a validáciu
